        ...
        <#if realm.password>
        	...
        	<div id="tabs" style="display: block; width: 100%; margin: 0px;">
            	...
            	<div class="resp-tabs-container tabs">
                    <h2 class="resp-accordion tabs active" role="tab" aria-controls="tabs_tab_item-0">ClaveÚnica</h2>

                    <div class="resp-tab-content tabs resp-tab-content-active" aria-labelledby="tabs_tab_item-0" style="display:block">
                    ...
                    <br>
                        ...
                        <img src="${url.resourcesPath}/img/btn_claveunica_202px.png" alt="ClaveÚnica" class="btn-clave-unica"></a>
                            <br>
                            <br>
                            <br>
                     </div>
                ...
                <h2 class="resp-accordion tabs" role="tab" aria-controls="tabs_tab_item-2">Extranjero</h2>
                <div class="resp-tab-content tabs" aria-labelledby="tabs_tab_item-2">
                	<div class="form-center form-wrap">
                        <div class="input-wrap">
                            <#if usernameEditDisabled??>
                            <input tabindex="1" id="username" class="${properties.kcInputClass!}" name="username" value="${(login.username!'')}" type="text" disabled />
    ...
    <#elseif section = "info" >
        <#if realm.password && realm.registrationAllowed && !registrationDisabled??>
            <div id="kc-registration">
                <span>${msg("noAccount")} <a tabindex="6" href="${url.registrationUrl}">${msg("doRegister")}</a>
                </span>
            </div>
        </#if>
    </#if>
